...
public class Constants {
    ...
    public static final String generationError = "Erro no processo de Geração";
    public static final String missingFilters = "Necessário fornecer valor para todos os filtros";
    public static final String concurrentOperations = "Operações concorrentes";
    public static final String concurrentOperationsDesc = "Existem operações relacionadas com o módulo escolhido em progresso. Tente mais tarde, contacte um administrador ou cancele a operação a ser realizada";
    public static final String generationStarted = "Geração Iniciada";
    public static final String generationStartedDesc = "Geração iniciada com sucesso";
    ...
    public static final String noLockPermissions = "Não tem permissões de lock para a geração selecionada";
    public static final String noUnlockPermissions = "Não tem permissões de unlock para a geração selecionada";
    public static final String downloadError = "Erro no download do ficheiro pretendido";
    public static final String IMPORTSMASHLOGMESSAGE = "Os dados desta tabela foram atualizados devido a uma nova importação.";
    ...
    public static final String NOPRIVILEGESDETAILS = "Sem privilégios para ver os detalhes de importação existentes";
    public static final String validationError = "Erro no processo de Validação.";
