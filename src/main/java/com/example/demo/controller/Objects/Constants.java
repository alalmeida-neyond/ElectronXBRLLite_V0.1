...
public class Constants {
    ...
    public static final String NOMAPSSELECTED = "Deve selecionar pelo menos 1 mapa antes de iniciar a validacao.";
    ...
    public static final String IMPOSSIBLEUPLOAD = "Importacao falhou.";
    public static final String NOSELECTEDFILE = "Não foi selecionado ficheiro para importacao.";
    ...
    public static final String UPLOADFAILEDDESC = "Falha na importacao do ficheiro para a diretoria de importacao!";
